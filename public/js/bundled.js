(() => {
  ...
  var require_catchAsync = __commonJS({
    "utilities/catchAsync.js"(exports, module) {
      module.exports = function catchAsync2(fn) {
        return (req, res, next) => {
  ...
  var displayMap = (locations) => {
    mapboxgl.accessToken = "pk.eyJ1Ijoia2FuZXdhdHNvbiIsImEiOiJjbGhrNm5lNHMwcDZlM2dxcDZscnR6NWlyIn0.ctSH8VlO9P7Z7mLPcPdptA";
  ...
  var logout = async () => {
    try {
      ...
      showAlert("error", "Error. Try again in a moment.");
    }
  };
  ...
  var updateData = async (data, type) => {
    try {
      const url = type === "data" ? "http://localhost:3000/api/v1/users/update-me" : "http://localhost:3000/api/v1/users/update-my-password";
      const res = await axios_default({
        method: "PATCH",
        url,
        data
